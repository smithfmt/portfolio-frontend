...
const NavBar = () => {
    ...
    return (
        <>
        <nav className={`fixed top-0 left-0 w-full z-50 max-w-[100vw] flex justify-end bg-fade-bottom-black text-neutral-50 p-8 pb-16 md:p-4 md:pb-4 md:px-16 lg:px-48
