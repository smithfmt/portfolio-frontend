...
const Lines = ({ id, section }: { id: string, section:string }) => {
    ...
    return (
        <svg id={id} className="sticky top-0 md:-top-16 lg:-top-32 [&>path]:[stroke-dashoffset:4300]" viewBox="0 0 1812 4311" fill="none"color="currentColor" xmlns="http://www.w3.org/2000/svg">
